...
#include "$CurrentDir:missions\\DayZCommunityOfflineMode.fodland\\core\\modules\\DebugMonitor\\CustomDebugMonitor.c"
#include "$CurrentDir:missions\\DayZCommunityOfflineMode.fodland\\core\\modules\\DebugMonitor\\gui\\DebugMonitor.c"
#endif
